  ...
  return (
    <div>
      <div className="container mx-auto mb-2 ">
        <div className="flex justify-center text-xl font-bold align-middle mt-2 mb-2">
          {user.firstname !== undefined && `Welcome ${user.firstname + " " + user.lastname}`}
        </div>
        <div className="container mx-auto mb-4 text-gray-400">
          <div className="flex justify-center align-middle">
            <span className=" mr-3"> Switch User(Only for DEMO)</span>
